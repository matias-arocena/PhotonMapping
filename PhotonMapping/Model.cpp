...
Model::Model(RTCDevice device)
{
	...
	VertexBuffer[0] = 0.f; VertexBuffer[1] = 0.f; VertexBuffer[2] = 1.f;
	VertexBuffer[3] = 1.f; VertexBuffer[4] = 0.f; VertexBuffer[5] = 1.f;
	VertexBuffer[6] = 0.f; VertexBuffer[7] = 1.f; VertexBuffer[8] = 1.f;
